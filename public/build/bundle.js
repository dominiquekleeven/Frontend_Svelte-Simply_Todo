...
var app = (function () {
    ...
    /* src\pages\components\todo.svelte generated by Svelte v3.29.0 */

    const file = "src\\pages\\components\\todo.svelte";
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 64, 22, 1301);
    			attr_dev(li, "class", "todo-item svelte-nxmvre");
    			add_location(li, file, 64, 0, 1279);
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file, 62, 22, 1220);
    			attr_dev(li, "class", "todo-item svelte-nxmvre");
    			add_location(li, file, 62, 0, 1198);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, button);
    ...
    /* src\pages\components\todolist.svelte generated by Svelte v3.29.0 */

    const { console: console_1 } = globals;
    const file$2 = "src\\pages\\components\\todolist.svelte";
    ...
    function create_else_block_2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "Todo List Collection ✔";
    			t1 = space();
    			form = element("form");
    			label = element("label");
    			label.textContent = "Create a new list";
    			t3 = space();
    			input = element("input");
    			t4 = space();
    			div = element("div");
    		...
    		m: function mount(target, anchor) {
    			...
    			set_input_value(input, /*newlist*/ ctx[1].title);
    			append_dev(form, t4);
    			append_dev(form, div);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(form, "submit", /*createTodo*/ ctx[7], false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*newlist*/ 2 && input.value !== /*newlist*/ ctx[1].title) {
    				set_input_value(input, /*newlist*/ ctx[1].title);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_if_block_3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			h1 = element("h1");
    			h1.textContent = "You don't have any Todo lists 😿";
    			t1 = space();
    			form = element("form");
    			label = element("label");
    			label.textContent = "Create a new list";
    			...
    			button.textContent = "Create";
    			attr_dev(h1, "class", "svelte-uonabe");
    			add_location(h1, file$2, 266, 8, 6448);
    			attr_dev(label, "for", "todolist");
    			attr_dev(label, "class", "svelte-uonabe");
    			add_location(label, file$2, 268, 12, 6542);
    			input.required = true;
    			attr_dev(input, "placeholder", "My project");
    			attr_dev(input, "type", "text");
    			attr_dev(input, "class", "svelte-uonabe");
    			add_location(input, file$2, 269, 12, 6603);
    			attr_dev(button, "class", "svelte-uonabe");
    			add_location(button, file$2, 274, 33, 6788);
    			attr_dev(div, "class", "buttons svelte-uonabe");
    			add_location(div, file$2, 274, 12, 6767);
    			attr_dev(form, "class", "svelte-uonabe");
    			add_location(form, file$2, 267, 8, 6499);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, h1, anchor);
    			insert_dev(target, t1, anchor);
    ...
    function create_else_block_1(ctx) {
    	...
    	let mounted;
    	let dispose;
    	icon = new Icon({ props: { icon: faPlus.faPlus }, $$inline: true });
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$2, 301, 28, 7847);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*showItemCreate*/ ctx[4](/*todo*/ ctx[15].id))) /*showItemCreate*/ ctx[4](/*todo*/ ctx[15].id).apply(this, arguments);
    					},
    					false,
    					false,
    					false
    ...
    function create_if_block_2(ctx) {
    	...
    	icon = new Icon({
    			props: { icon: faTimesCircle.faTimesCircle },
    			$$inline: true
    		});
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(icon.$$.fragment);
    			attr_dev(button, "class", "icon-button svelte-uonabe");
    			add_location(button, file$2, 296, 28, 7583);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			mount_component(icon, button, null);
    ...
    function create_if_block_1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "type", "text");
    			add_location(input, file$2, 317, 28, 8559);
    			attr_dev(button, "class", "svelte-uonabe");
    			add_location(button, file$2, 323, 49, 8875);
    			attr_dev(div, "class", "buttons svelte-uonabe");
    			add_location(div, file$2, 323, 28, 8854);
    			attr_dev(form, "class", "custom-form svelte-uonabe");
    			add_location(form, file$2, 316, 24, 8480);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, form, anchor);
    			append_dev(form, input);
    			set_input_value(input, /*newitem*/ ctx[2].name);
    			append_dev(form, t0);
    			append_dev(form, div);
    			append_dev(div, button);
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(input, "input", /*input_input_handler_2*/ ctx[11]),
    					listen_dev(form, "submit", /*createItem*/ ctx[6], false, false, false)
    				];
    		...
    		p: function update(ctx, dirty) {
    			if (dirty & /*newitem*/ 4 && input.value !== /*newitem*/ ctx[2].name) {
    				set_input_value(input, /*newitem*/ ctx[2].name);
    			}
    		},
    		d: function destroy(detaching) {
    ...
    function create_else_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(span, file$2, 333, 28, 9346);
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*updateTodoItem*/ ctx[8](/*todo*/ ctx[15], /*item*/ ctx[18]))) /*updateTodoItem*/ ctx[8](/*todo*/ ctx[15], /*item*/ ctx[18]).apply(this, arguments);
    					},
    					false,
    					false,
    					false
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			const todo_changes = {};
    			if (dirty & /*todos*/ 1) todo_changes.description = /*item*/ ctx[18].name;
    ...
    function create_if_block$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(todo.$$.fragment);
    			attr_dev(span, "class", "item svelte-uonabe");
    			add_location(span, file$2, 329, 28, 9097);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, span, anchor);
    			mount_component(todo, span, null);
    ...
    function create_each_block(ctx) {
    	let li;
    	let span1;
    	let t0_value = /*todo*/ ctx[15].title + "";
    	let t0;
    	let t1;
    	let span0;
    	let current_block_type_index;
    	...
    	function select_block_type_1(ctx, dirty) {
    		if (/*item_input*/ ctx[3].visible && /*item_input*/ ctx[3].id == /*todo*/ ctx[15].id) return 0;
    		return 1;
    	}
    	...
    	const block = {
    		c: function create() {
    			...
    			t5 = space();
    			attr_dev(button, "class", "icon-button svelte-uonabe");
    			add_location(button, file$2, 307, 24, 8100);
    			attr_dev(span0, "class", "buttons svelte-uonabe");
    			add_location(span0, file$2, 294, 20, 7453);
    			attr_dev(span1, "class", "todo-name svelte-uonabe");
    			add_location(span1, file$2, 293, 16, 7395);
    			attr_dev(ul, "class", "todo-item-list svelte-uonabe");
    			add_location(ul, file$2, 314, 16, 8353);
    			attr_dev(li, "class", "todo svelte-uonabe");
    			add_location(li, file$2, 292, 12, 7360);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, span1);
    			...
    			if (!mounted) {
    				dispose = listen_dev(
    					...
    					"click",
    					function () {
    						if (is_function(/*deleteTodo*/ ctx[5](/*todo*/ ctx[15].id))) /*deleteTodo*/ ctx[5](/*todo*/ ctx[15].id).apply(this, arguments);
    					},
    					false,
    					false,
    					false
    		...
    		p: function update(new_ctx, dirty) {
    			ctx = new_ctx;
    			if ((!current || dirty & /*todos*/ 1) && t0_value !== (t0_value = /*todo*/ ctx[15].title + "")) set_data_dev(t0, t0_value);
    			let previous_block_index = current_block_type_index;
    			current_block_type_index = select_block_type_1(ctx);
    			...
    			if (/*item_input*/ ctx[3].visible && /*item_input*/ ctx[3].id == /*todo*/ ctx[15].id) {
    				if (if_block1) {
    ...
    function create_fragment$2(ctx) {
    	...
    	function select_block_type(ctx, dirty) {
    		if (/*todos*/ ctx[0].length <= 0) return create_if_block_3;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(hr, file$2, 289, 4, 7299);
    			attr_dev(ul, "class", "svelte-uonabe");
    			add_location(ul, file$2, 290, 4, 7311);
    			attr_dev(div, "class", "todolist svelte-uonabe");
    			add_location(div, file$2, 264, 0, 6387);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	let newlist = {};
    	let newitem = {};
    	let item_input = { visible: false };

    	onMount(async () => {
    		console.log("Welcome to Simply Todo - If you're reading this it probably means that you have your developer console open 🔥 ");
    		await checkIfAuthorized();
    		await fetchTodos();
    	});

    	async function showItemCreate(id) {
    		$$invalidate(3, item_input.visible = !item_input.visible, item_input);

    		if (item_input.id === id) {
    			$$invalidate(3, item_input.id = 0, item_input);
    		}

    		$$invalidate(3, item_input.id = id, item_input);
    	}

    	async function deleteTodo(id) {
    		const response = await fetch(`${{"env":{"isProd":false,"API_URL":"http://localhost:3000/api/v1"}}.env.API_URL}/todos/${id}`, {
    			method: "DELETE",
    			headers: {
    	...
    	async function createItem(e) {
    		...
    		const response = await fetch(`${{"env":{"isProd":false,"API_URL":"http://localhost:3000/api/v1"}}.env.API_URL}/todos/${item_input.id}/items`, {
    			method: "POST",
    			headers: {
    				"Content-Type": "application/json",
    				Authorization: usertoken
    	...
    	async function createTodo(e) {
    		...
    		const response = await fetch(`${{"env":{"isProd":false,"API_URL":"http://localhost:3000/api/v1"}}.env.API_URL}/todos/`, {
    			method: "POST",
    			headers: {
    				"Content-Type": "application/json",
    				Authorization: usertoken
    	...
    	$$self.$capture_state = () => ({
    		...
    		faTimesCircle: faTimesCircle.faTimesCircle,
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("newlist" in $$props) $$invalidate(1, newlist = $$props.newlist);
    		if ("newitem" in $$props) $$invalidate(2, newitem = $$props.newitem);
    		if ("item_input" in $$props) $$invalidate(3, item_input = $$props.item_input);
    	};
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h2, file$3, 68, 4, 1067);
    			add_location(strong, file$3, 69, 7, 1092);
    			attr_dev(p, "class", "svelte-3hs4jq");
    			add_location(p, file$3, 69, 4, 1089);
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$4, 51, 4, 957);
    			attr_dev(p0, "class", "subtitle svelte-wfnr1o");
    			add_location(p0, file$4, 52, 4, 983);
    			attr_dev(p1, "class", "time svelte-wfnr1o");
    			add_location(p1, file$4, 53, 4, 1028);
    			attr_dev(div, "class", "header svelte-wfnr1o");
    			add_location(div, file$4, 50, 0, 931);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(main, file$5, 14, 0, 336);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 129, 12, 2941);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    function create_if_block$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$7, 122, 12, 2681);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    ...
    /* src\pages\components\navbar.svelte generated by Svelte v3.29.0 */
    const file$8 = "src\\pages\\components\\navbar.svelte";
    ...
    function create_else_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(button, file$8, 35, 8, 920);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			mount_component(icon, button, null);
    ...
    function create_if_block$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			create_component(icon.$$.fragment);
    			attr_dev(button, "class", "nav-item svelte-1gw52fy");
    			add_location(button, file$8, 31, 8, 785);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, button, anchor);
    			mount_component(icon, button, null);
    ...
    function create_fragment$8(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(button, "class", "nav-item svelte-1gw52fy");
    			add_location(button, file$8, 26, 4, 643);
    			attr_dev(span, "class", "acc-buttons");
    			add_location(span, file$8, 29, 4, 721);
    			attr_dev(nav, "class", "navbar svelte-1gw52fy");
    			add_location(nav, file$8, 25, 0, 617);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$8($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ("home_icon" in $$props) $$invalidate(0, home_icon = $$props.home_icon);
    	...
    	return [home_icon, login_icon, logout_icon];
    }
